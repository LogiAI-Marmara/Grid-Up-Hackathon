...
svg.add('<line x1="%g" y1="%g" x2="%g" y2="%g" stroke="#c62828" stroke-width="1"/>' % (px(53.5, 46.6) + px(55, 45.1)))   # künye → sensör
x, y = px(31, 40.6)
...
L(px(65, 66)[0], px(65, 66)[1], 'çıkış +5V / GND', 10, SUB); L(px(95, 66)[0], px(95, 66)[1], 'giriş L / N', 10, SUB, 'end')
...
x, y = px(43.5, 33); svg.leader(x, y, px(42.2, 31.9)[0], px(42.2, 31.9)[1], ['boost U7 + L', 'çıkış 4,6 V → D2'], 10, SUB, 'end', dot=False, halo=BG)
x, y = px(49, 27.75); L(x, y + 3.5, 'dengeleme 2×', 10, '#f57f17', 'middle')
x, y = px(43.75, 21.6); L(x, y, 'MAX3485', 10, SUB, 'middle')
