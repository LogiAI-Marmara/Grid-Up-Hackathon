...
def build():
    ...
    RV1 = S.part(RV, 'RV1', 'MOV', (71.12, (ac_l[1] + ac_n[1]) / 2), ref_at=(74.4, ac_l[1] - 3.9), val_at=(79.6, ac_l[1] - 3.9))   # etiketler L hattının üstünde, gövdeden kılavuz çizgi
    S.gline((72.5, ac_l[1] + 1.7), (74.6, ac_l[1] - 3.3), COL['GND'], 0.2)
    ...
    Pg5.val_at = (U5.p('-Vout')[0] + 2.54, U5.p('-Vout')[1] + 4.9); Pg5.just = 'center'   # GND yazısı üçgenin altında, ortalı
