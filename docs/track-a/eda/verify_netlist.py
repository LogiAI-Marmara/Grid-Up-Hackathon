...
EXP = {
    ...
    ('U6', '1'): '+5V', ('U6', '3'): '+3V3', ('U6', '2'): 'GND',              # LDO AP7361C-33E: VI=1, GND=2, VO=3 (tab)
    ('R50', '1'): '5V_RAW', ('R50', '2'): 'VSENSE', ('R51', '1'): 'VSENSE', ('R51', '2'): 'GND',  # bölücü D1 öncesi
    ('R52', '1'): '+5V', ('D2', '1'): '+5V',                                  # R_şarj rayda, D2 K rayda
    ('C33', '2'): 'GND', ('R54', '2'): 'GND', ('U7', '1'): 'GND', ('R56', '2'): 'GND',   # süperkap alt hücre, dengeleme, boost, FB bölücü
...
SAME = [
    ...
    [('R52', '2'), ('C32', '1'), ('R53', '1'), ('U7', '6'), ('U7', '4'), ('L1', '1')],      # süperkap düğümü → boost VI = EN, L1
    [('C32', '2'), ('C33', '1'), ('R53', '2'), ('R54', '1')],                                # hücre orta noktası (dengeleme)
    [('U7', '5'), ('L1', '2')], [('U7', '2'), ('R55', '1'), ('D2', '2')], [('U7', '3'), ('R55', '2'), ('R56', '1')],  # SW / VOUT → D2 A / FB
